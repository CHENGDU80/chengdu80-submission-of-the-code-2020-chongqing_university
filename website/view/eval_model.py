from view.lstm_model import StockMovementPrediction
...
init_X = np.load('view/data/init.npy')
...
if __name__ == '__main__':
    train_data, test_date, ground_true, pred = get_lstm_prediction('A')
    print(train_data)
    print(test_date)
    print(ground_true)
    print()
